 ...
 * docker run --rm  --network=alfa -p 8080:8080  -ti b33rsledge/caveservice:v2 java -jar /caveservice.jar --spring.redis.host=alpha-redis --spring.redis.port=6379
 * docker run --rm  --network=alfa -p 8080:8080  -ti b33rsledge/caveservice:v2 java -jar /caveservice.jar --spring.redis.host=alpha-redis --spring.redis.port=6379 --spring.profiles.active=fakeStorage
 * <p>
 * Trobleshooting
...
/*
    ...
    @ClassRule
    public static GenericContainer alfaRedisServer =
            new GenericContainer("redis:6.2.5-alpine")
                    .withExposedPorts(SERVER_REDIS_PORT)
                    .withNetworkAliases(REDIS_NETWORKNAME)
                    .withNetwork(network);
*/
